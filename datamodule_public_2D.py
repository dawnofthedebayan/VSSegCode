...
class UKEDataloader(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        mask_t1 = cv2.imread(mask_path, cv2.IMREAD_GRAYSCALE)
        image_t2 = cv2.imread(image_path_t2, cv2.IMREAD_GRAYSCALE)
        mask_t2 = cv2.imread(mask_path, cv2.IMREAD_GRAYSCALE)
...
class PublicDSSegmentationDataModule2D(pl.LightningDataModule):
